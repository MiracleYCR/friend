<template>
  ...
  >
    ...
    >
      <div v-if="props.searchType === 'conversation' && !isUniFrameWork" class="tui-search-header">
        ...
        <div class="tui-search-header-close" @click="closeSearchContainer">
          <Icon :file="closeDarkIcon" width="14px" height="14px" />
        </div>
      </div>
      ...
      <slot name="input" />
      <div v-if="isTimeTabsShow" class="tui-search-time">
        <div
        ...
        >
          <div v-if="tabItem.key === 'all'" class="tui-search-time-item-picker">
            ...
            >
              ...
              <Icon :file="downArrowIcon" width="14px" height="14px" />
            </div>
            <div @click.stop>
              <DatePicker
                v-if="isDatePickerShow"
